    ...
    extend: {
      ...
      keyframes: {
        ...
        "slide-in-stop": {
          ...
          "98%": {
            transform: "translateX(0.2px) scale(1)",
            opacity: "1",
            zIndex: "10"
          },
          "100%": {
      ...
      animation: {
        ...
        "slide-in-stop": "slide-in-stop 2.8s cubic-bezier(0.25, 0.46, 0.45, 0.94)",
        "dust-cloud": "dust-cloud 2.8s cubic-bezier(0.25, 0.46, 0.45, 0.94)",
      },
    },
  },
